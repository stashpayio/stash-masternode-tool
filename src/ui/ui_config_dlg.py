...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabStashd = QtWidgets.QWidget()
        self.tabStashd.setObjectName("tabStashd")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabStashd)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabStashd)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboStashNetwork = QtWidgets.QComboBox(self.tabStashd)
        self.cboStashNetwork.setObjectName("cboStashNetwork")
        self.cboStashNetwork.addItem("")
        self.cboStashNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboStashNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabStashd)
        ...
        self.tabWidget.addTab(self.tabStashd, "")
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "Stash network:"))
        self.cboStashNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboStashNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabStashd), _translate("ConfigDlg", "Stash network"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (StashCentral.org)"))

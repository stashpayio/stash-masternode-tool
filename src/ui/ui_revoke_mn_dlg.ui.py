...
# Form implementation generated from reading ui file '/Users/blogin/Projects/stash-masternode-tool/src/ui/ui_revoke_mn_dlg.ui.autosave'
#
...
class Ui_RevokeMnDlg(object):
    ...
    def retranslateUi(self, RevokeMnDlg):
        ...
        self.lblDescription.setText(_translate("RevokeMnDlg", "This transaction is used by the operator to terminate service or signal the owner that a new BLS key is required (<a href=\"https://docs.stash.org/en/stable/masternodes/maintenance.html#prouprevtx\">details</a>)."))

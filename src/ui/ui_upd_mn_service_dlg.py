...
# Form implementation generated from reading ui file '/Users/blogin/Projects/stash-masternode-tool/src/ui/ui_upd_mn_service_dlg.ui'
#
...
class Ui_UpdMnServiceDlg(object):
    ...
    def retranslateUi(self, UpdMnServiceDlg):
        ...
        self.label.setText(_translate("UpdMnServiceDlg", "The transaction type associated with this action (ProUpServTx) is used to update information relating to the operator (<a href=\"https://docs.stash.org/en/stable/masternodes/maintenance.html#proupservtx\">details</a>)."))
